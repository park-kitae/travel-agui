# Graph Report - /Users/kitaepark/project/agent/sample-agent/ag-ui-demo/travel-agui  (2026-06-23)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 842 nodes · 1548 edges · 86 communities (47 shown, 39 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 212 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3895cb60`
...
- `Start Script` --calls--> `AG-UI Gateway`  [INFERRED]
...
Cohesion: 0.06
Nodes (33): dependencies, lucide-react, @radix-ui/react-dialog, react, react-dom, @tauri-apps/api, devDependencies, playwright (+25 more)
...
Cohesion: 0.16
Nodes (10): Any, Store already-serialized plugin state without inspecting it., SerializedStateStore, AgentCard, LlmAgent, _StubAgent, _StubAgentCard, test_domain_runtime_exposes_startup_wrappers() (+2 more)

### Community 17 - "Community 17"
Cohesion: 0.12
Nodes (15): compilerOptions, allowImportingTsExtensions, composite, declaration, declarationMap, isolatedModules, lib, module (+7 more)
...
Cohesion: 0.34
Nodes (12): cleanup(), get_npm_cmd(), get_pids_on_port(), kill_pids(), kill_proc(), main(), cleanup(), tail -f 대체: 파일을 실시간 출력 (+4 more)
...
Cohesion: 0.27
Nodes (4): Any, RuntimeEmission, StubPlugin, test_domain_plugin_is_importable_and_declares_required_methods()
...
Cohesion: 0.24
Nodes (11): A2A Server, Converter, Domain Runtime, Executor, Fake Domain Plugin, App Icon, React Client, AG-UI Gateway (+3 more)
...
Cohesion: 0.44
Nodes (9): initialize_runtime_or_die(), reset_runtime_for_tests(), MonkeyPatch, teardown_function(), test_get_runtime_raises_before_initialization(), test_initialize_runtime_or_die_defaults_to_travel_when_env_missing(), test_initialize_runtime_or_die_loads_plugin_once_and_returns_shared_singleton(), test_initialize_runtime_or_die_raises_on_plugin_load_failure() (+1 more)
...
Cohesion: 0.29
Nodes (7): State Panel Sidebar Change Spec, Spec-Driven with Tests Schema, Design Template, Proposal Template, Specs Template, Tasks Template, Tests Template
...
## Knowledge Gaps
- **140 isolated node(s):** `LlmAgent`, `LlmAgent`, `LlmAgent`, `LlmAgent`, `Request` (+135 more)
...
- **Why does `State Panel Sidebar Proposal` connect `Community 22` to `Community 19`, `Community 4`, `Community 31`?**
  _High betweenness centrality (0.161) - this node is a cross-community bridge._
- **Why does `apply_tool_result()` connect `Community 0` to `Community 11`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `ADKAgentExecutor` connect `Community 1` to `Community 3`, `Community 13`?**
